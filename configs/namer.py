...
def generate_name(g_conf):
    ...
    if 'perception' in g_conf.MODEL_CONFIGURATION:
        ...
        elif g_conf.MODEL_TYPE == 'coil-icra-VAE': # FOR NOW IT IS A COIL_ICRA MODEL WITH VAE
            final_name_string += '_' + str(len(g_conf.MODEL_CONFIGURATION['perception']['fc']['neurons'])) +'fc'
